      ...
      <div className="flex flex-1 flex-col overflow-hidden min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="flex bg-slate-100 rounded-full px-4 py-1.5 items-center gap-2">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-tight">Acesso Premium</span>
            </div>
        ...
        <footer className="h-8 bg-slate-100 border-t border-slate-200 px-6 flex items-center justify-between shrink-0 text-[9px] font-medium text-slate-500">
          <div className="flex gap-4">
            <span>Status do Sistema: <span className="text-green-600">Online</span></span>
            <span>Versão: v2.1.0-stable</span>
          </div>
          <div className="flex gap-4">
            <a href="#" className="hover:text-blue-600 transition-colors">Termos de Uso</a>
            <a href="#" className="hover:text-blue-600 transition-colors">Políticas de Privacidade</a>
