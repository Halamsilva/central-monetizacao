  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 p-4">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-blue-700 via-blue-800 to-blue-900 p-10 text-white shadow-xl shadow-blue-100"
      >
      ...
      {isAdmin && (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-black text-slate-900">{stats.featured}</p>
          </div>

          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <p className="text-xs font-black uppercase tracking-widest text-slate-400">Prompts e Roteiros</p>
            <p className="mt-2 text-3xl font-black text-slate-900">{stats.prompts}</p>
          </div>

          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <p className="text-xs font-black uppercase tracking-widest text-slate-400">Links</p>
            <p className="mt-2 text-3xl font-black text-slate-900">{stats.links}</p>
          </div>
        </div>
      )}
